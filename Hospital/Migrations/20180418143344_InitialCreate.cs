        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Paciente = table.Column<string>(maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Medicamento = table.Column<string>(maxLength: 200, nullable: false),
                    PrescricaoId = table.Column<int>(nullable: false),
                    Quantidade = table.Column<int>(nullable: false),
                    UnidadeDeMedida = table.Column<string>(maxLength: 30, nullable: false),
                    ViaDeAdm = table.Column<string>(maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dosagens", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Dosagens_Prescricoes_PrescricaoId",
